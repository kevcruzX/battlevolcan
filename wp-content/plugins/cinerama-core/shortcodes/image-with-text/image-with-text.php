<?php
namespace CineramaCore\CPT\Shortcodes\ImageWithText;
...
class ImageWithText implements Lib\ShortcodeInterface {
	...
	public function vcMap() {
		if ( function_exists( 'vc_map' ) ) {
			vc_map(
				array(
					'name'                      => esc_html__( 'Image With Text', 'cinerama-core' ),
					'base'                      => $this->getBase(),
	...
	public function render( $atts, $content = null ) {
		...
		$html = cinerama_core_get_shortcode_module_template_part( 'templates/image-with-text', 'image-with-text', '', $params );
	...
	private function getHolderClasses( $params ) {
		...
		$holderClasses[] = $params['enable_animation'] === 'yes' ? 'edgtf-iwt-animation' : '';
