<?php
if ( ! function_exists( 'cinerama_edge_init_google_fonts_array' ) ) {
    function cinerama_edge_init_google_fonts_array() {
        ...
        $cinerama_edge_global_fonts_array = $google_fonts_decoded['items'];
    }
    add_action('after_setup_theme', 'cinerama_edge_init_google_fonts_array');
}