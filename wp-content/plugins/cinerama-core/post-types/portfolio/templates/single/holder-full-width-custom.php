				...
				<?php if(post_password_required()) {
					...
					<div class="edgtf-container">
						<div class="edgtf-container-inner clearfix">
							<?php cinerama_core_get_cpt_single_module_template_part('templates/single/parts/navigation', 'portfolio', $item_layout); ?>
							<?php cinerama_core_get_cpt_single_module_template_part('templates/single/parts/comments', 'portfolio'); ?>
						</div>
					</div>
				<?php } ?>
			</div>
