<?php
namespace CineramaCore\CPT\Shortcodes\BlogList;
...
class BlogList implements Lib\ShortcodeInterface {
	...
	public function vcMap() {
		vc_map(
			array(
				'name'                      => esc_html__( 'Blog List', 'cinerama' ),
				'base'                      => $this->base,
				...
				'params'                    => array(
					...
					array(
						'type'        => 'dropdown',
						'param_name'  => 'skin',
						'heading'     => esc_html__( 'Skin', 'cinerama' ),
						'value'       => array(
					...
					array(
						...
						'heading'     => esc_html__( 'Text Length', 'cinerama' ),
						'description' => esc_html__( 'Number of words', 'cinerama' ),
					...
					array(
						...
						'heading'    => esc_html__( 'Enable Post Info Image', 'cinerama' ),
					...
					array(
						...
						'heading'    => esc_html__( 'Enable Post Info Section', 'cinerama' ),
						'value'      => array_flip( cinerama_edge_get_yes_no_select_array( false, true ) ),
						'dependency' => Array( 'element' => 'type', 'value'   => array( 'standard', 'boxed', 'masonry' ) ),
						'group'      => esc_html__( 'Post Info', 'cinerama' )
					),
					...
					array(
						...
						'heading'    => esc_html__( 'Enable Post Info Like', 'cinerama' ),
						'value'      => array_flip( cinerama_edge_get_yes_no_select_array( false ) ),
						'dependency' => Array( 'element' => 'post_info_section', 'value' => array( 'yes' ) ),
						'group'      => esc_html__( 'Post Info', 'cinerama' )
					),
					array(
						...
						'heading'    => esc_html__( 'Enable Post Info Share', 'cinerama' ),
						'value'      => array_flip( cinerama_edge_get_yes_no_select_array( false ) ),
						'dependency' => Array( 'element' => 'post_info_section', 'value' => array( 'yes' ) ),
						'group'      => esc_html__( 'Post Info', 'cinerama' )
					),
					array(
						...
						'heading'    => esc_html__( 'Show Read More Button', 'cinerama' ),
						'value'      => array_flip( cinerama_edge_get_yes_no_select_array( false ) ),
						'group'      => esc_html__( 'Additional Features', 'cinerama' )
					),
					array(
						'type'       => 'dropdown',
						'param_name' => 'pagination_type',
						'heading'    => esc_html__( 'Pagination Type', 'cinerama' ),
						'value'      => array(
							esc_html__( 'None', 'cinerama' )            => 'no-pagination',
							esc_html__( 'Standard', 'cinerama' )        => 'standard-shortcodes',
							esc_html__( 'Load More', 'cinerama' )       => 'load-more',
							esc_html__( 'Infinite Scroll', 'cinerama' ) => 'infinite-scroll'
						),
						'group'      => esc_html__( 'Additional Features', 'cinerama' )
					)
				)
	...
	public function render( $atts, $content = null ) {
		...
		cinerama_edge_get_module_template_part( 'shortcodes/blog-list/holder', 'blog', $params['type'], $params );
	...
	public function getHolderClasses( $params, $default_atts ) {
		...
		$holderClasses[] = ! empty( $params['skin'] ) ? 'edgtf-bl-' . $params['skin'] : '';
		$holderClasses[] = $params['post_info_image'] === 'yes' ? 'edgtf-bl-has-image' : 'edgtf-pl-no-image';
