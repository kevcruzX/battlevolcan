...
if ( ! function_exists( 'cinerama_edge_get_hide_dep_for_header_main_menu_options' ) ) {
	function cinerama_edge_get_hide_dep_for_header_main_menu_options() {
		$hide_dep_options = apply_filters( 'cinerama_edge_filter_header_main_menu_hide_global_option', $hide_dep_options = array() );
		
		return $hide_dep_options;
	}
}

if ( ! function_exists( 'cinerama_edge_header_main_navigation_options_map' ) ) {
	function cinerama_edge_header_main_navigation_options_map() {
		$hide_dep_options = cinerama_edge_get_hide_dep_for_header_main_menu_options();
		
		$panel_main_menu = cinerama_edge_add_admin_panel(
			array(
				'title'           => esc_html__( 'Main Menu', 'cinerama' ),
		...
		cinerama_edge_add_admin_section_title(
			array(
				...
				'title'  => esc_html__( 'Main Menu General Settings', 'cinerama' )
			)
		);
		...
		$drop_down_group = cinerama_edge_add_admin_group(
			array(
				...
				'description' => esc_html__( 'Choose a color and transparency for the main menu background (0 = fully transparent, 1 = opaque)', 'cinerama' )
			)
		);
		
		$drop_down_row1 = cinerama_edge_add_admin_row(
			array(
		...
		cinerama_edge_add_admin_field(
			array(
				...
				'label'         => esc_html__( 'Main Dropdown Menu Appearance', 'cinerama' ),
				'description'   => esc_html__( 'Choose appearance for dropdown menu', 'cinerama' ),
				'options'       => array(
					'dropdown-default'        => esc_html__( 'Default', 'cinerama' ),
					'dropdown-animate-height' => esc_html__( 'Animate Height', 'cinerama' )
				)
			)
		);
		...
		$first_level_group = cinerama_edge_add_admin_group(
			array(
				...
				'description' => esc_html__( 'Define styles for 1st level in Top Navigation Menu', 'cinerama' )
			)
		);
		...
		cinerama_edge_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Light Menu Hover Text Color', 'cinerama' ),
			)
		);
		...
		cinerama_edge_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Light Menu Active Text Color', 'cinerama' ),
			)
		);
		
		$first_level_row4 = cinerama_edge_add_admin_row(
			array(
				'parent' => $first_level_group,
		...
		cinerama_edge_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Dark Menu Hover Text Color', 'cinerama' ),
			)
		);
		...
		cinerama_edge_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Dark Menu Active Text Color', 'cinerama' ),
			)
		);
		
		$first_level_row5 = cinerama_edge_add_admin_row(
			array(
				'parent' => $first_level_group,
		...
		$first_level_row6 = cinerama_edge_add_admin_row(
			array(
				'parent' => $first_level_group,
		...
		$first_level_row7 = cinerama_edge_add_admin_row(
			array(
				'parent' => $first_level_group,
		...
		cinerama_edge_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Padding Left/Right', 'cinerama' ),
				'args'          => array(
					'suffix' => 'px'
				)
			)
		...
		cinerama_edge_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Margin Left/Right', 'cinerama' ),
				'args'          => array(
					'suffix' => 'px'
				)
			)
		...
		$second_level_group = cinerama_edge_add_admin_group(
			array(
				...
				'title'       => esc_html__( '2nd Level Menu', 'cinerama' ),
				'description' => esc_html__( 'Define styles for 2nd level in Top Navigation Menu', 'cinerama' )
			)
		);
		...
		$second_level_wide_group = cinerama_edge_add_admin_group(
			array(
				'parent'      => $panel_main_menu,
				'name'        => 'second_level_wide_group',
				'title'       => esc_html__( '2nd Level Wide Menu', 'cinerama' ),
				'description' => esc_html__( 'Define styles for 2nd level in Wide Menu', 'cinerama' )
			)
		);
		
		$second_level_wide_row1 = cinerama_edge_add_admin_row(
			array(
		...
		$second_level_wide_row2 = cinerama_edge_add_admin_row(
			array(
				'parent' => $second_level_wide_group,
		...
		$second_level_wide_row3 = cinerama_edge_add_admin_row(
			array(
				'parent' => $second_level_wide_group,
		...
		$third_level_group = cinerama_edge_add_admin_group(
			array(
				...
				'title'       => esc_html__( '3nd Level Menu', 'cinerama' ),
				'description' => esc_html__( 'Define styles for 3nd level in Top Navigation Menu', 'cinerama' )
			)
		);
		...
		$third_level_wide_group = cinerama_edge_add_admin_group(
			array(
				'parent'      => $panel_main_menu,
				'name'        => 'third_level_wide_group',
				'title'       => esc_html__( '3rd Level Wide Menu', 'cinerama' ),
				'description' => esc_html__( 'Define styles for 3rd level in Wide Menu', 'cinerama' )
			)
		);
		
		$third_level_wide_row1 = cinerama_edge_add_admin_row(
			array(
		...
		$third_level_wide_row2 = cinerama_edge_add_admin_row(
			array(
				'parent' => $third_level_wide_group,
		...
		$third_level_wide_row3 = cinerama_edge_add_admin_row(
			array(
				'parent' => $third_level_wide_group,
	...
	add_action( 'cinerama_edge_action_header_main_navigation_options_map', 'cinerama_edge_header_main_navigation_options_map', 10, 1 );
}